...
Criar gráfico a partir dos dados estimados da [**tabela 6471**](https://sidra.ibge.gov.br/tabela/6471).
...
```{r grafico,  out.width="100%", fig.align='center', dpi=600, fig.width = 12, fig.height = 8}
# Carregando pacotes
library(dplyr)
library(tidyr)
library(ggplot2)
